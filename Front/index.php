            ...
            <div class="sobre-beneficios">
                <div class="beneficio-item">
                    <span class="beneficio-icon">
                        <svg width="32" height="32" fill="#dcaf8b" viewBox="0 0 24 24">
                            <path
                                d="M3 13h2v-2H3v2zm0 4h2v-2H3v2zm0-8h2V7H3v2zm4 8h14v-2H7v2zm0-4h14v-2H7v2zm0-6v2h14V7H7z" />
                        </svg>
                    </span>
                    <span><strong>Gestão eficiente:</strong> Organize turmas, disciplinas e atividades de forma
                        centralizada.</span>
                </div>
                <div class="beneficio-item">
                    <span class="beneficio-icon">
                    ...
                    <span><strong>Comunicação integrada:</strong> Facilite o contato entre todos os membros da
                        comunidade escolar.</span>
                </div>
                <div class="beneficio-item">
                    <span class="beneficio-icon">
                        <svg width="32" height="32" fill="#dcaf8b" viewBox="0 0 24 24">
                ...
                <div class="beneficio-item">
                    ...
                    <span><strong>Foco na inovação:</strong> Soluções tecnológicas para otimizar o tempo e melhorar
                        resultados.</span>
                </div>
            </div>
