...
$stmt = $conn->prepare('SELECT m.idMateria, m.nomeMateria, m.detalhesMateria, u.nomeUsuario AS professor FROM materias m LEFT JOIN usuario u ON m.idUsuario = u.idUsuario'
);
$stmt->execute();
